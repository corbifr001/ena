    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'HELP_ADD_FIELD_IS_UNIQUE':
                return __("Mark this field as unique. No two users can submit same value for this field. Any subsequent attempt for submission with duplicate value with show a message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htisunique'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_WIDGET_LABEL':
                return __("MagicWidget labels do not appear on form. They only appear inside submissions and submission PDFs.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FIELD_HELP_TEXT_YOUTUBE':
                 return __("Insert a YouTube Video in your form.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_WIDGET_YT_AUTOPLAY':  
             ...
             case 'HELP_ADD_WIDGET_URL':
                 return __("Enter URL which you want to link to the anchor text.",'custom-registration-form-builder-with-submission-manager');   
             
             case 'HELP_ADD_WIDGET_LINK':
                return __("The clickable text that will be linked to specified URL or page.", 'custom-registration-form-builder-with-submission-manager');
                 
             case 'HELP_ADD_WIDGET_ANCHOR_LINK':
                 return __("Link a page or a specific URL to the Anchor Text.",'custom-registration-form-builder-with-submission-manager');
              
             case 'FIELD_HELP_TEXT_IFRAME':
                 return __(" Display an external webpage inside your form, using HTML iframe.",'custom-registration-form-builder-with-submission-manager');
