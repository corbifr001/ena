...
<div class="rmagic rmbasic">
  ...
  <!-- Joyride Magic ends -->
    ...
    <div class="rmagic-cards" id="rm-card-area">
        ...
        <div id="rm-import-template" class="rmcard">
             <div class="rm-import-template"><a href="#rm_import_template_popup" onclick="CallModalBox(this)"><span><i class="material-icons">&#xE2C6;</i></span></a><a href="#rm_import_template_popup" onclick="CallModalBox(this)">Upload Template</a></div>
             <div class="rm-browse-template"><span><a href="http://registrationmagic.com/templates" target="__blank"><i class="material-icons">&#xE8F0;</i></a></span><a href="http://registrationmagic.com/templates" target="_blank">Browse Templates</a></div>
        </div>
...
?>
    ...
    <!-- Template Upload -->
    <div id="rm_import_template_popup" class="rm-modal-view" style="display:none">
        <div class="rm-modal-overlay"></div>

        <div class="rm-modal-wrap rm-import-template-popup-wrap">
            <div class="rm-modal-titlebar">
                <div class="rm-modal-title">
                    <?php echo RM_UI_Strings::get('LABEL_UPLOAD_FORM_TEMPLATE'); ?>
                </div>
                <span onclick="cancel_file_upload()" class="rm-modal-close">&times;</span>
            </div>
            <div class="rm-modal-container">
                <div class="rm_import_template">
                    <div class="rm_import_template_note"> Upload the <b>RMmagic.xml</b> file you downloaded here.</div>
                <form enctype="multipart/form-data" method="post" id="upload_form">
                    <div class="rm_import_template_uploade"> <input accept=".xml" type="file" name="file" id="xml_file" onchange="check_file_extension(this)"></div>
                   <div id="status" class="rm_import_template_upload_status"></div> 
                    <progress style="display:none" id="progressBar" value="0" max="100" style="width:100%;"></progress>
                    <div id='rm_import_progress'></div>
                    <div id='rm_import_errors'></div>
                    <div class="rm_import_template-footer"><a href="javascript:void(0)" onclick="uploadFile()" id="rm_import_template_upload">Upload</a></div>
                </form>
                </div>
            </div>         
